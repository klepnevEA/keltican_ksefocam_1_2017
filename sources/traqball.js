...
(function(){
    ...
    Traqball.prototype.disable = function(){
        if(this.box !== null){
            ...
            bindEvent(document.getElementById("stage1"), 'touchmove', this.evHandlers[1], "remove");
            bindEvent(document.getElementById("stage1"), 'touchend', this.evHandlers[2], "remove");
        }
    }
    ...
    Traqball.prototype.setup = function(conf){
        ...
        (function init (){
            ...
            if(THIS.config.auto){
										var countStep = 0; 
										startrotationAuto([680, 368], 0.02)
										intervalID = setInterval( function() {
											countStep++; 
											var aCoords = [(680-countStep), 368];
											var angleTurn = 0.01*countStep;
											
											rotateAuto(aCoords, angleTurn);
											
											//if( countStep>628 ) { clearInterval(intervalID); };
										}, 20);
            };
        ...
        function startrotation(e){  
            ...
            bindEvent(document.getElementById("stage1"), 'touchmove', rotate);
            bindEvent(document.getElementById("stage1"), 'touchend', finishrotation);            
        };
    
											function startrotationAuto(aCoords, angleTurn){  
												mouseDownVect   = calcZvector(aCoords);
												oldTime         = curTime = new Date().getTime();
												oldAngle        = angle; 
        ...
        function finishrotation(e){
            ...
            bindEvent(document.getElementById("stage1"), 'touchmove', rotate, "remove");
            bindEvent(document.getElementById("stage1"), 'touchend', finishrotation, "remove");
            bindEvent(THIS.box, 'touchstart', startrotation);
            calcSpeed();
            if( impulse && delta > 0){
        ...
        function rotate(e){
            ...
            e.preventDefault();           console.log(eCoords)
            ...
            angle = calcAngle(mouseDownVect, mouseMoveVect);												//console.log(angle)
            ...
            curTime = new Date().getTime();
									...
									function rotateAuto(aCoords, angleTurn) {
										var eCoords = aCoords;
																   						//console.log(eCoords)
										oldTime = curTime;
										oldAngle = angle;
										...
										// Now that we have the normal, we need the angle of the rotation.
										// Easy to find by calculating the angle between mouseDownVect and mouseMoveVect:
										angle = angleTurn;															//console.log(angle)
